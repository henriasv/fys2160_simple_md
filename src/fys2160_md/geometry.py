...
def FCC(*, N=500, rho=None, box=None, molecule=None, bond=None, model=None, seed=87287):
    ...
    return System(_atoms(centers,lengths,model,rng,bond),lengths,model=model,bond=bond)


def Random(*, N=500, rho=None, box=None, min_distance=.9, max_attempts=1000,
           molecule=None, bond=None, model=None, seed=87287):
    ...
    return System(positions,lengths,model=model,bond=bond)
